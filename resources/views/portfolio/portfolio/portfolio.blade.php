...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('public/portfolio/assets/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
  <link href="{{ asset('public/portfolio/assets/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
  <link href="{{ asset('public/portfolio/assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
  <link href="{{ asset('public/portfolio/assets/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
  <link href="{{ asset('public/portfolio/assets/vendor/remixicon/remixicon.css')}}" rel="stylesheet">
  <link href="{{ asset('public/portfolio/assets/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">
...
<body style="background: #040404 url({{ $banner['banner'] }}) top right no-repeat; background-size: cover;">
  ...
  <div class="credits">
    ...
    Designed by <a href="">Wajid Ali</a>
  </div>

  <!-- Vendor JS Files -->
  <script src="{{ asset('public/portfolio/assets/vendor/purecounter/purecounter.js')}}"></script>
  <script src="{{ asset('public/portfolio/assets/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
  <script src="{{ asset('public/portfolio/assets/vendor/glightbox/js/glightbox.min.js')}}"></script>
